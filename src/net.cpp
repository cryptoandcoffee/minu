...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitocointools.com", "188.68.38.46"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bitocointools.com", "testnet-seed.bitocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitocoin is probably already running."), addrBind.ToString().c_str());
        else
